...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(blank=True, default='default-lettings/default.webp', null=True, upload_to='')),
            ],
        ),
        migrations.CreateModel(
            name='Letting',
            fields=[
                ...
                ('image', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='lettings.LettingsImage')),
            ],
        ),
    ]
